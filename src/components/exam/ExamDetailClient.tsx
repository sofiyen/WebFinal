    ...
    <div className="flex gap-6">
      <section className="flex-1 rounded-xl border border-slate-200 bg-white p-4">
        <header className="flex items-start justify-between gap-4">
          <div>
            <p className="text-[0.7rem] text-slate-400">考古題編號 #{exam._id.substring(exam._id.length - 6)}</p>
            <h1 className="mt-2 text-xl font-semibold text-slate-900">
              {exam.title}
            </h1>
            <p className="mt-2 text-[1.1rem] text-slate-500">
              課程：{exam.courseName} ‧ {exam.instructor} ‧ {exam.semester} ‧ {exam.examType}
            </p>
          ...
          <div className="flex flex-col items-end gap-2 text-[1rem]">
            <button
              ...
              className={`inline-flex items-center gap-1 rounded-full px-4 py-1.5 text-[0.8rem] font-medium transition-colors ${
                isFlashed 
            ...
            <div className="relative">
              <button
                ...
                className={`flex items-center gap-1 rounded-md border px-4 py-1.5 text-[0.8rem] transition-colors ${
                  isSaved
